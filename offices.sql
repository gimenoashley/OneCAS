...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2023 at 04:55 PM
...
INSERT INTO `offices` (`ofc_id`, `name`, `description`, `mission`, `vision`, `ofc_linkone`, `ofc_linktwo`, `ofc_linkthree`, `ofc_mail`) VALUES
(1, 'Office of the Chancellor', '<default>', '<default>', '<default>', 'https://www.facebook.com/U.P.Visayas.Official', NULL, NULL, 'oc.upvisayas@up.edu.ph'),
(2, 'Office of the Vice Chancellor for Academic Affairs', '<default>', '<default>', '<default>', 'https://www.facebook.com/UPVOVCAA', NULL, NULL, 'ovcaa.upvisayas@up.edu.ph'),
...
(5, 'Office of the Vice Chancellor for Planning and Development', '', '', '', '', NULL, NULL, 'ovcpd.upvisayas@up.edu.ph'),
(6, 'Office of the College of Arts and Sciences Dean', '', 'Through the programs in the liberal arts and sciences, the College of Arts and Sciences seeks to:\r\n1. Nurture the Intellect and creative capabilities of empowered individuals and groups for responsible citizenship through an understanding and appreciation', 'A premier institution of liberal arts and science education sensitive and responsive to the needs of changing times locally and internationally.', '', NULL, NULL, 'cas.upvisayas@up.edu.ph'),
(7, 'Office of the College Secretary', '', 'To achieve a high sense of professionalism by responding to the clients’ requests with utmost courtesy, ensuring and delivering prompt, efficient and high quality services.', 'The Office of the College Secretary is dedicated and committed to provide prompt, efficient and quality services in the interests of the clients of the College of Arts and Sciences', '', NULL, NULL, 'cas-sec.upvisayas@up.edu.ph, cassecofc@gmail.com'),
(8, 'Office of the University Registrars', '', '', '', 'https://www.facebook.com/ourupvisayas', NULL, NULL, 'our.upvisayas@up.edu.ph'),
...
(10, 'Computerized Registration System', '', '', '', 'http://crs.upv.edu.ph/', 'https://www.facebook.com/upvisayas.crsis', NULL, 'crs.upvisayas@up.edu.ph'),
(11, 'University Student Council', '', '', '', 'https://www.facebook.com/uscupv', 'twitter.com/upv_usc', '', 'upvuniversitystudentcouncil@gmail.com'),
(12, 'College of Arts and Sciences Student Council', '', '', '', 'facebook.com/UPVCASSC', 'https://twitter.com/UPVCASSC', NULL, 'cassc.upv@gmail.com');
